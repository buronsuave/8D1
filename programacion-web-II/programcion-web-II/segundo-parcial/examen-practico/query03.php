...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>03. Crear XML de Query 03.</title>
	</head>

	<body>
		<h1>03. Consulta de Clientes con Ciudad Tonala (TNL)</h1>
		<?php 
            ...
            $xslt = $clientes->createProcessingInstruction('xml-stylesheet', 'type="text/xsl" href="view03.xsl"');
