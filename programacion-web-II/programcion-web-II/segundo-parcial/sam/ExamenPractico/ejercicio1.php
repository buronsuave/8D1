...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<?php 
			...
			$query="SELECT * FROM clientes WHERE LimCredC > 10000";
            ...
            $clientes->save("ejercicio1.xml");
			echo "<br>XML generado<br>";
		?>

        <h1>Clientes con crédito mayor a 10,000</h1>
        <?php $clientes = simplexml_load_file("ejercicio1.xml"); ?>
        Clientes: 
        <select name="Cliente">
            <?php foreach ($clientes->Cliente as $cliente) { ?>
                <option value="<?php echo $cliente->NombC;?>">
                    <?php echo $cliente->NombC;?>
                </option>
            <?php } ?>
        </select>
	</body>
